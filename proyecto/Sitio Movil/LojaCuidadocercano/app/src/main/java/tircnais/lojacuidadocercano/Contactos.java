...
public class Contactos extends AppCompatActivity {
    ...
    //miURL.setPagina("contact.html");
    String url = servidor+proyecto+"contact.html"; //miURL.getIPservidor()+miURL.getProyecto()+miURL.getPagina();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contactos);
        inicioWeb = (WebView) this.findViewById(R.id.wbContactos);
